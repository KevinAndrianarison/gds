            ...
            <CommandGroup>
              {types.map((type) => (
                ...
                >
                  ...
                  />
                  {type.nom} {(type.categorie.isVehicule === 1 || type.categorie.isVehicule === "1") && <FontAwesomeIcon icon={faCarSide} className="ml-2 text-blue-500 p-1 rounded-full bg-blue-100" />}
                </CommandItem>
              ))}
            </CommandGroup>
          </Command>
