...
export default function Entete({ titre, description }) {
    return (
        <div className='border-b-2 border-gray-100 py-2'>
            ...
            <p className='flex items-center flex-wrap mt-4 gap-1 text-gray-700'><FontAwesomeIcon icon={faThumbtack} className="text-yellow-500" /> « <b>Ajouter, modifier ou supprimer</b> » {description}</p>
        </div>)
}
